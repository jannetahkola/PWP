...
class GameServerProcessControllerIT extends WireMockTest {
    ...
    @SneakyThrows
    @Test
    void givenRequestWithInvalidParams_thenBadRequestResponse() {
        given()
                .header(authorizationHeader)
    ...
    void givenStartProcessRequest_whenAlreadyUp_thenBadRequestResponse() {
        mockGameProcess();
        ...
        // Game process itself logs that it's ready to accept connections
        gameOut.write("Started\n".getBytes(StandardCharsets.UTF_8));
    ...
    @SneakyThrows
    @RepeatedTest(value = 3, failureThreshold = 1)
    void givenStopProcessRequest_whenAlreadyDown_thenBadRequestResponse() {
        mockGameProcess();
    ...
    @SneakyThrows
    @Test
    void givenStopProcessRequest_whenStillStarting_thenBadRequestResponse() {
        mockGameProcess();
    ...
    @SneakyThrows
    @Test
    void givenStartThenStopRequest_thenOkResponse() {
        mockGameProcess();
